...
class Ui_AcercaDeDialog(QtGui.QDialog):
  def __init__(self): 
    ...
    self.ui.herevea.setPixmap(QtGui.QPixmap(icon_path))
    icon_path = os.path.join(dir,'img\FEDER.png')
    self.ui.feder.setPixmap(QtGui.QPixmap(icon_path))
    icon_path = os.path.join(dir,'img\logoConsejeria.png')
    self.ui.consejeria.setPixmap(QtGui.QPixmap(icon_path))
    icon_path = os.path.join(dir,'img\LogoAndalucia.png')
    self.ui.andalucia.setPixmap(QtGui.QPixmap(icon_path))
    icon_path = os.path.join(dir,'img\us.png')
    self.ui.us.setPixmap(QtGui.QPixmap(icon_path))     